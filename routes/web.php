...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('admin/support/delete_multi_item', [SupportController::class, 'delete_multi_item']);
    ...
    Route::post('admin/discount_code/add', [DiscountCodeController::class, 'discount_code_store']);
    ...
    Route::get('admin/transactions/edit/{id}', [TransactionsController::class, 'transactions_edit']);
    Route::post('admin/transactions/update/{id}', [TransactionsController::class, 'transactions_update']);
    // Transactions End
