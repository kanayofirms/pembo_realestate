                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ url('admin/blog/edit/' . $getRecord->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="getTitle" class="form-control" name="title"
                                        value="{{ $getRecord->title }}" placeholder="Enter Title" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="getSlug" class="form-control" name="slug"
                                        value="{{ $getRecord->slug }}" placeholder="Enter Slug" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" class="form-control editor" placeholder="Enter Description">{!! $getRecord->description !!}</textarea>
                                </div>
                            </div>
