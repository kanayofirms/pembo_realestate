                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ url('admin/qrcode/edit' . $getRecord->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="price"
                                        value="{{ $getRecord->price }}" placeholder="Enter Price" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="description" placeholder="Enter Description">{{ $getRecord->description }}</textarea>
